...
<h1 align="center">Цифровой портал СПК «Хорошово-1»</h1>
...
SPK Portal — это динамический многофункциональный портал для управления садоводческим потребительским кооперативом.
